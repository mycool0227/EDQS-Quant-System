...
out_path = base / 'result' / 'em_weekly_recommendation_2025-12-08_online_relaxed_dd.csv'
...
if non_st.empty:
    raise SystemExit('Top3 all ST after filter.')
...
print(weighted[['code','name','weight','strength','composite_score','weekly_return']].to_string(index=False))
